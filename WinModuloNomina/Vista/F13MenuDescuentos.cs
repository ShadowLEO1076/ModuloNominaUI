    ...
    public partial class F13MenuDescuentos : Form
    {
        ...
        private async void OpenChildForm(Form childForm)
        {
            try
            {
                ...
                panelMostrar2.Controls.Clear();

                panelMostrar2.Controls.Add(childForm);
                panelMostrar2.Tag = childForm;
        ...
        private void btnPorInasistir_Click(object sender, EventArgs e)
        {
            OpenChildForm(new F15FaltasD());
        }

        private void btnIndividual_Click(object sender, EventArgs e)
        {
            OpenChildForm(new F5Descuentos());
        }

        private void btnCalculadora_Click(object sender, EventArgs e)
        {
            OpenChildForm(new F14CalculadoraD());
        }

        private void F13MenuDescuentos_Load(object sender, EventArgs e)
        {
